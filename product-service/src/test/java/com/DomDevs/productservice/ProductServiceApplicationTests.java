...
class ProductServiceApplicationTests {
    ...
    void shouldCreateProduct() throws Exception {
        ...
        mockMvc.perform(MockMvcRequestBuilders.post("/api/product/create").contentType(MediaType.APPLICATION_JSON).content(productRequestAsString)).andExpect(status().isCreated());
